...
class Ui_ModelTrainerUI(object):
    def setupUi(self, ModelTrainerUI):
        ...
        self.trainable_layers_label = QtWidgets.QLabel(self.transfer_learning_checkBox)
    ...
    def retranslateUi(self, ModelTrainerUI):
        ...
        self.trainable_layers_label.setText(_translate("ModelTrainerUI", "trainable layers"))
